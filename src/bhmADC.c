...
const uint32_t qaunta = 5*fixed_point/1024; // Volts per step,  with 5v Vcc
const uint64_t Ah = 2*fixed_point*3600; // should be set to match the storage capacity of the battery, in Ah, converted to As
// N*10^-2. 100%, down in %5increments.
//https://blog.ampow.com/lipo-voltage-chart/
const uint16_t cellV_LUT[21] = {
	420*cell_num, 415*cell_num, 411*cell_num, 408*cell_num, 
	402*cell_num, 398*cell_num, 395*cell_num, 391*cell_num, 
	...
	// V = 11*.01*I
	// I = V/(11*.01)
const uint32_t amp_per_v = (fixed_point)/11*100;
